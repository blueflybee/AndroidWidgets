 ...
 *
 * Created by CJS on 16/1/22 00:33.
 */
public class BallPulseRiseIndicator extends BaseIndicator {
    ...
    public List<Animator> createAnimation() {
        ...
        ObjectAnimator animator = ObjectAnimator.ofPropertyValuesHolder(getTarget(), rotationX);
